mongoexport.exe --db=natural_med --collection=full_health_care_meta --limit=100000 --skip=20000 --type=csv --fields asin,title,description,imUrl --out=../../Dumps/natural_metadata.csv
